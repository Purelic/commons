...
import net.purelic.commons.api.text.ClickAction;
import net.purelic.commons.api.text.TextBuilder;
...
public enum Rank {
    ...
    MODERATOR("Moderator", '»', ChatColor.RED, "Helps with moderating public and private servers", "staff", HELPER),
    MAP_DEVELOPER("Map Developer", '»', ChatColor.BLUE, "Helps with creating maps for the server", "staff"),
    DEVELOPER("Developer", '»', ChatColor.DARK_PURPLE, "Helps with developing features for the server", "staff", MAP_DEVELOPER),
    ADMIN("Admin", '»', ChatColor.DARK_RED, "Helps run and administrate the network", "staff", MODERATOR),
    ;
    ...
    Rank(String name, Character flair, ChatColor color, String description, String page, @Nullable Rank childRank) {
        this.name = name;
