...
public class ChatUtils {
    ...
    public static void sendQuitMessage(UUID uuid, String server) { //TODO move this code to a listener
    ...
    public static void broadcastPunishment(UUID punisherId, String type, UUID punishedId, String reason) { //TODO: move this code to a listener(violation event?)
    ...
    public static void broadcastReport(UUID reporterId, UUID reportedId, String reason) { //TODO: etc..
